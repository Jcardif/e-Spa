...
AS
SELECT c.ID,c.FirstName, c.LastName,ap.Date, ap.Venue, ss.Price,ss.Discount,s.Name AS SalonName, se.Name AS ServiceName, se.Image, sm.PhoneNo, sm.Email, sm.FirstName AS SMFirstName, sm.LastName AS SMLastName
FROM [dbo].Client   c
